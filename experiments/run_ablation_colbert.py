...
COLBERT_SRC_DIR = Path(__file__).parent.parent / "colbert-reproduce-copy/colbert-replicability/colbert"
...
DATA_DIR = Path("/media/12TB/shared/datasets/raw/trec-tot-2025")
...
COLBERT_CONFIG = {
    "model_path": "/media/12TB/shared/models/colbertv2.0",
    "max_steps": 1500,
    "batch_size": 16,
    "grad_accum": 2,
    "learning_rate": 3e-6,
