...
def main():
    ...
    embeddings_path = "/media/12TB/shared/datasets/indices/msmarco-passage/msmarco-passage-constbert/constbert_msmarco_embeddings.npy"
    metadata_path = "/media/12TB/shared/datasets/indices/msmarco-passage/msmarco-passage-constbert/constbert_msmarco_faiss_index.pkl"
    
    if args.test:
        index_path = "/media/12TB/shared/datasets/indices/msmarco-passage/constbert_plaid_index_test"
