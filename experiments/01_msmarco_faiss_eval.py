...
os.environ['HF_HOME'] = '/media/12TB/shared/models/huggingface'
os.environ['TRANSFORMERS_CACHE'] = '/media/12TB/shared/models/huggingface/transformers'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data-dir",
        type=str,
        default="/media/12TB/shared/datasets/raw/msmarco-passage",
    ...
    parser.add_argument(
        "--embeddings-dir",
        type=str,
        default="/media/12TB/shared/datasets/processed/msmarco-passage",
    ...
    parser.add_argument(
        "--index-dir",
        type=str,
        default="/media/12TB/shared/datasets/indices",
