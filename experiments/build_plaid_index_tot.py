...
Embeddings: Already exist at /media/12TB/shared/datasets/indices/trec-tot-2025/constbert_tot_faiss_index/embeddings.npy
...
def main():
    ...
    parser.add_argument('--embeddings_path', type=str,
                       default='/media/12TB/shared/datasets/indices/trec-tot-2025/constbert_tot_faiss_index/embeddings.npy',
                       help='Path to pre-computed embeddings')
    parser.add_argument('--metadata_path', type=str,
                       default='/media/12TB/shared/datasets/indices/trec-tot-2025/constbert_tot_faiss_index/metadata.npy',
                       help='Path to metadata (doc IDs)')
    parser.add_argument('--output_path', type=str,
                       default='/media/12TB/shared/datasets/indices/trec-tot-2025/constbert_tot_plaid_index',
