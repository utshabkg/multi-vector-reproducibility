...
COLBERT_PATH = Path(__file__).parent.parent / "external" / "ColBERT"
...
def main():
    ...
    parser.add_argument('--index-dir', type=str, default='/media/12TB/shared/datasets/indices/colbertv2-beir',
