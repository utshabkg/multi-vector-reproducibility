...
COLBERT_COPY = PROJECT_ROOT / "colbert-reproduce-copy"
BASE_CHECKPOINT = Path("/media/12TB/shared/models/colbertv2.0")
INDICES_ROOT = Path("/media/12TB/shared/datasets/indices/trec-tot-2025")
CORPUS_JSONL = Path("/media/12TB/shared/datasets/raw/trec-tot-2025/trec-tot-2025-corpus.jsonl")
...
def evaluate_index(seed: int, index_path: Path) -> dict:
    ...
    sys.path.insert(0, str(PROJECT_ROOT / "external/ColBERT"))
