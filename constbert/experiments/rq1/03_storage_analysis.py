...
# Check our files
embeddings_path = Path("data/msmarco-passage/constbert_msmarco_embeddings.npy")
index_faiss_path = Path("indices/constbert_msmarco_faiss_index.faiss")
index_pkl_path = Path("indices/constbert_msmarco_faiss_index.pkl")
